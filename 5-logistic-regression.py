...
def logistic_regression(arr1,arr2):
    numPoints = 200
    boundary = .5
    learning_rate = .1
    max_iterations = 500
    ...
    plt.scatter(arr1[:, 0], arr1[:, 1], s=20, label='Category 1')
    plt.scatter(arr2[:, 0], arr2[:, 1], s=20, label='Category 2')
    plt.legend()
    plt.show()   
...
logistic_regression(circle1,circle2)